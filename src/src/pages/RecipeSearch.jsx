...
const RecipeSearch = () => {
  ...
  const getRecommendation = async () => {
    ...
    try {
      const fullPrompt = `당신은 전문 영양사입니다. 다음 요청에 따라 레시피를 추천하고, 결과는 한국어로 제공해 주세요. 각 레시피는 **제목, 이 레시피의 장점, 주요 재료, 간단 조리법**을 반드시 포함해야 합니다. 결과를 깔끔한 마크다운 형식으로 작성해주세요.\n\n[사용자 요청]:\n${prompt}`;
  ...
  return (
    <div className="p-4 max-w-3xl mx-auto">
      <h1 className="text-3xl font-bold mb-6 text-white text-center">AI 레시피 검색/추천</h1>
